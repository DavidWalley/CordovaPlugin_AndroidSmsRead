...
function                        ////////////////////////////////////////////////////////////// Define a procedure to:   [2012-12-11 davidwalley.ca ED11]
 ...
 ,[0 ,5]                                                                                   // and start index, together with maximum number of results to return.   [2012-12-15 davidwalley.ca 565B 2012-12-17 davidwalley.ca]
                                                                                            //
 ,function(a_a2sResult){                                                                    // On success of the above, run the following:   [2012-12-15 davidwalley.ca 1A7B 2012-12-17 davidwalley.ca]
   ...
   for( var i = 0; i < a_a2sResult.length; i++ ){                                           // Scroll through the returned data, and   [2012-12-15 davidwalley.ca E0C2 2012-12-17 davidwalley.ca]
    sResults += a_a2sResult[i].date                                                         //                          [2012-12-20 davidwalley.ca C678]
        +": '"+ a_a2sResult[i].address                                                      //                          [2012-12-20 davidwalley.ca 8384]
       +"', '"+ a_a2sResult[i].body    +"'<br />";                                          // add the contents of the phone number and message contents fields to the results text string.   [2012-12-15 davidwalley.ca 29DF 2012-12-20 davidwalley.ca]
